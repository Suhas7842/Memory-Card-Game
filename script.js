...
window.onload = function() {
    $("#ol").html(`<center>
                        <div id="inst">\
                            <h3>Welcome !</h3>
                            Instructions to the game<br/><br/>
                            <li>Make pairs of similiar cards by flipping them.</li>
                            <li>To flip a card you can click on it.</li>
                            <li>If two cards you clicked are not similar, they will be flipped back.</li>
...
function change(x) {
  ...
  //Flip
    ...
    if (rem==0) {
          ...
          let score = calculateScore(moves, time);
          setTimeout(function() {
              $("#ol").html(`<center>
                                <div id="iol">
                                    <h2>Congratulations!</h2>
                                    <p style="font-size:23px;padding:10px;">You completed the ${mode} mode in ${moves} moves under ${time}.</p>
                                    <p style="font-size:18px">Your Score: ${score}<br/>Play Again ?</p>
                                    <button onclick="start(3, 4)">3 x 4</button> 
                                    <button onclick="start(4, 4)" style="w">4 x 4</button>
                                    <button onclick="start(4, 5)">4 x 5</button>
                                    <button onclick="start(5, 6)">5 x 6</button>
...
function calculateScore(moves, time) {
    // You can customize the scoring algorithm based on your preference
    let timeInSeconds = min * 60 + sec;
    let score = Math.round((100 - moves) * (100 / timeInSeconds));
